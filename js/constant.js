const prompts = [
  ...
  const replies = [
    ...
    ["My name is Avinash kishore."],
    ["I completed my B.Tech in Electronic and communication Engineering from NIT Patna."],
    [
    ...
    [
      "I was a volunteer at NSS Patna and a PR Team Member at the IEE Club, NIT Patna."
    ],
    [
      "I enjoy playing Karate, Cricket, and reading research papers."
    ]
  ];
